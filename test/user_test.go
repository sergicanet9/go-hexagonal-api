...
func TestLoginUser_Ok(t *testing.T) {
	Databases(t, func(t *testing.T, database string) {
		...
		url := fmt.Sprintf("%s:%d/go-hexagonal-api/%s/users/login", cfg.Address, cfg.Port, database)
...
func TestCreateUser_Created(t *testing.T) {
	Databases(t, func(t *testing.T, database string) {
		...
		url := fmt.Sprintf("%s:%d/go-hexagonal-api/%s/users", cfg.Address, cfg.Port, database)
...
func TestGetUserByEmail_Ok(t *testing.T) {
	Databases(t, func(t *testing.T, database string) {
		...
		// Act
		url := fmt.Sprintf("%s:%d/go-hexagonal-api/%s/users/email/%s", cfg.Address, cfg.Port, database, testUser.Email)
...
func TestGetUserByID_Ok(t *testing.T) {
	Databases(t, func(t *testing.T, database string) {
		...
		// Act
		url := fmt.Sprintf("%s:%d/go-hexagonal-api/%s/users/%s", cfg.Address, cfg.Port, database, testUser.ID)
...
func TestGetUserClaims_Ok(t *testing.T) {
	Databases(t, func(t *testing.T, database string) {
		...
		// Act
		url := fmt.Sprintf("%s:%d/go-hexagonal-api/%s/claims", cfg.Address, cfg.Port, database)
